                                        ...
                                        {order.items?.length > 0 ? (
                                            <ul className="list-unstyled mb-0 small">
                                                {order.items.slice(0, 3).map(item => (
                                                    <li key={item.id}>
                                                        <span className="text-truncate d-inline-block" style={{ maxWidth: '150px' }} title={item.product?.name || 'Deleted Product'}>
                                                ...
                                                {order.items.length > 3 && (
                                                    <li className="text-muted">+{order.items.length - 3} more</li>
                                                )}
                                            </ul>
                                        ) : (
